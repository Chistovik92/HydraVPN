...
### Верификация
- `assembleStubDebug` — BUILD SUCCESSFUL.
...
- **Xiaomi 12T Pro (Android 15, HyperOS)** — новое устройство в матрице
  живого тестирования: установка, вёрстка на большом экране (вырез,
  жестовая навигация), полный цикл подключения/отключения, темы, пинг,
  профиль, логи. Крашей не найдено (stub-флейвор — нативные ядра
  недоступны офлайн).
