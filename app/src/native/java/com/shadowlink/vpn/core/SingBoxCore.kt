...
import com.shadowlink.data.subscription.SingBoxConfigBuilder
...
class SingBoxCore : VpnCore {
    ...
    override fun start(
        ...
        val platform = ShadowLinkPlatformInterface(
            existingTun = tun,
            onLogLine = onLog,
        )
        ...
        // Периодический опрос статистики через CommandClient (см. ShadowLinkPlatformInterface)
...
class ShadowLinkPlatformInterface(
